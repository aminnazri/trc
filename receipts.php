...
$sql = "SELECT * FROM receipts where user_id  =  $user_id  $condition AND year=$year";
...
if ($result->num_rows > 0) {
  // Output the data for each row in a card
  $no_receipt = "";

} else {
  $no_receipt = "image/6028969.jpg";
...
function delete($id)
{
    $sql = "DELETE FROM receipts WHERE image_id = $id";
...
<section class="gallery min-vh-100">
    <div class="container-lg " >
      ...
      <div class="row gy-4  row-cols-1 row-cols-sm-2 row-cols-md-4" style="display:flex; align-item:center; justify-content:center;"><img src="<?= $no_receipt?>" alt="" class="no_receipt" style="width:500px; ">
        <?php $count = 0;
                      ...
                      <div class="menu-nav">
                        ...
                        <div class="dropdown-container" tabindex="-1">
                          ...
                          <div class="dropdown">
                            ...
                            <!-- <a href="javascript:deleteItem(<?= $image_id?>,'<?= $folder?>',<?= $year?>);"><div><i class='bx bx-trash' ></i>Delete</div></a> -->
...
<script type="text/javascript">
  ...
  function deleteItem(image_id, folder, year){
    if (confirm("Are you sure you want to delete this item?")) {
      // window.location.href = "index.php?delete="+id;
      window.location.href = "delete.php?image_id="+image_id+"&f="+folder+"&year="+year;
    }
  }
